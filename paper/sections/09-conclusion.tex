...
\begin{enumerate}
  \item a \textbf{per-AU \mbox{VLM-as-AU-rater} agreement protocol}: a measurement
  of whether a frozen vision--language model can weak-label FGS action units at
  human-rater agreement, reported as five per-AU quadratic $\kappa$ values

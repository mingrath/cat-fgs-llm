...
2 & Confound-attribution protocol &
  FGS-BG-Gap $+$ per-AU EBPG \citep{xiao2021noise,moayeri2022comprehensive,adebayo2022posthoc},
  \emph{one-directional} (``no confound detected at this power'') & Yes (headline) \\
3 & $\kappa$ reliability check &
  Per-AU VLM-vs-vet quadratic-weighted $\kappa$ \citep{cohen1968kappa} reported on
  its \emph{CI lower bound}; guarded, inspected-not-validated & Yes (guarded check) \\

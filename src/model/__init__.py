...
(cited supporting plumbing) and src.eval (the headline confound protocol +
guarded kappa check); they never produce a claimed-novel artifact. Distributional CORN decode is the default; hard argmax

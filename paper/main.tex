...
\title{%
  ...
  \large Two Portable Methods on a Binary-plus-Wrapper Spine ---\\
...
\vspace{0.8em}
{\large Two Portable Methods on a Binary-plus-Wrapper Spine\par}
\vspace{0.4em}
...
\input{sections/03-data-and-materials}
\input{sections/04-methodology-engine}
\input{sections/05-methodology-vlm-and-wrapper}
\input{sections/06-evaluation-protocol-and-gates}
\input{sections/07-expected-outcomes-and-risk}
\input{sections/08-ethics-welfare-limitations}

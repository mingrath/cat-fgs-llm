...
headlines still stand, because the $\kappa$ protocol---once the independent
per-AU vet anchor exists---measures a real fact whether the result is strong or
mediocre.
...
\begin{enumerate}
  \item \textbf{A VLM-as-AU-rater $\kappa$ protocol (result pending the
    independent vet anchor).} Released code that
    ...
    the deliverable is the reusable measurement protocol; the number it will

...
evidence}, never headlines. The engine (frozen DINOv2 ViT-S/14
...
G1-B &
  ...
  still stand (a mediocre but real first $\kappa$ measurement is publishable). \\[2pt]
G1-B &
...
to be independently publishable: a mediocre per-AU $\kappa$ is still the first
measurement of whether a frozen vision-language model can weak-label feline FGS
action units at human-rater agreement, and a confounding signal detected as a
transportable protocol is a publishable co-headline regardless of downstream
outcomes. The binary-plus-wrapper spine survives the loss of the graded layer by
construction.

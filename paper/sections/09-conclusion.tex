...
\begin{enumerate}
  ...
  dataset rather than a verdict about this one. Its novelty is the \emph{assembly}
  and the per-AU EBPG-as-confound-evidence instantiation of equivalence-style audit
  hygiene \cite{huanghooker2026fairness,singh2023samplesize,adebayo2022posthoc}, not
  ...
  The CI-lower-bound gate is standard clinimetrics and the rubric-paraphrase guard is
  published \cite{tractenberg2010kappa,donner2010kappa,weng2026policy}; neither is

...
\begin{enumerate}
  ...
  one-directional, \emph{per-AU} audit (\emph{FGS-BG-Gap} counterfactual plus
  per-AU energy-based pointing game, EBPG, as saliency-as-confound-evidence,
  with a VLM judge-bias probe) that detects whether the scorer is reading
  acquisition context rather than grimace. This is the strong leg: it is
...
\cite{tractenberg2010kappa,donner2010kappa,simwright2005kappa}, the CI
half-width planning uses \texttt{kappaSize}
...
\cite{tractenberg2010kappa,donner2010kappa,simwright2005kappa}, and the
canonical $0.60$ acceptable lower bound is adopted from that literature
...
The wrapper's primary artifact is \emph{not} a calibration plot but a
...
\S\ref{sec:decision-curve}, which is the wrapper's primary artifact. This
